...
<head>
    ...
    <title>Registro - Tutorias Online</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            overflow: hidden;
            background: radial-gradient(circle at top right, #003666, #002a51);
        }
...
<body>
    <div class="login-card">
        <h2>Crear Cuenta</h2>
        <p class="subtitle">Únete a la mejor plataforma de tutorías.</p>
